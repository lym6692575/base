  ...
  <el-row>
    <el-container class="el-container" ref="containerElement">
      <el-aside width="auto" class="aside" ref="asideElement">
        <work-position-aside class="pr20"/>
      </el-aside>
      <el-container class="pl10">
        <work-position-main ref="mainElement"/>
      </el-container>
    </el-container>
  </el-row>
</template>
...
import Vue from 'vue'
import workPositionAside from './workPositionAside'
import workPositionMain from './workPositionMain'
