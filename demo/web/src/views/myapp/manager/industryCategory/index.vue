...
<template>
  <div>
    ...
    <el-row :gutter="20">
      <el-col>
        <industryCategoryTable ref="tableRef" v-model="queryParams" />
      </el-col>
    </el-row>
    <!-- 新增对话框 -->
    <industryCategoryAddDialog ref="addRef" @data-saved="onSearch()" />
  </div>
</template>

<script>
import industryCategoryTable from "./industryCategoryTable.vue";
import industryCategoryAddDialog from "./industryCategoryAddDialog.vue";
