...
<template>
  <div>
    ...
    <!-- 编辑对话框 -->
    <industryCategoryEditDialog ref="editRef" @data-saved="handelSearch()" />
  </div>
</template>

  <script>
import industryCategoryEditDialog from "./industryCategoryEditDialog.vue";
import { getTDywlb, deleteTDywlb } from "@/api/app/manager/industryCategory";
import { mapGetters } from "vuex";
import leeTable from "@/components/elementUI/lee-table/index.vue";
export default {
  components: {
    leeTable,
    industryCategoryEditDialog,
  },
  props: {
    value: {
      type: Object,
