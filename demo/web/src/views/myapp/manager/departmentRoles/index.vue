  ...
  <el-row style="width: 100%">
    <el-container class="el-container" ref="containerElement">
      <el-aside width="auto" class="aside" ref="asideElement">
        <department-roles-aside class="pr20" />
      </el-aside>
      <el-container class="pl20">
        <department-roles-main ref="mainElement"/>
      </el-container>
    </el-container>
  </el-row>
</template>
...
<script>
import Vue from "vue";
import departmentRolesAside from "./departmentRolesAside";
import departmentRolesMain from "./departmentRolesMain";
