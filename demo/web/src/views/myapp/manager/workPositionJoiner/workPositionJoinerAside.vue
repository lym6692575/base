  ...
  methods: {
    ...
    handleNodeClick(data) {
      if (data.type == "gwgl") {
        ...
        this.eventBus.gwnameArr = this.getNameFromTree(this.rawData, data.id)
        Vue.set(this.eventBus, 'gwnameArr', this.getNameFromTree(this.rawData, data.id));
      }
    },
